                ...
                <tbody>
                    @foreach($departments as $dept)
                        ...
                        <div class="modal fade" id="modal-department{{$dept->id}}">
                            <form role="form" method="post" action="{{ route('getdepartments', ['id' => $dept->id, 'days'=>'custom']) }}" target="__blank" id="vehicleForm">
                                @csrf
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header" >
                                            <h4 class="modal-title">Generate Report for {{$dept->name}} </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <ul class="nav nav-pills flex-column">
                                                        <li class="nav-item">
                                                            <a href="{{ route('getdepartment', ['id' => $dept->id, 'days'=>'today']) }}" target="__blank" class="nav-link">
                                                                <i class="far fa-circle text-info"></i>
                                                                Today
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="{{ route('getdepartment', ['id' => $dept->id, 'days'=>'yesterday']) }}" target="__blank"  class="nav-link">
                                                                <i class="far fa-circle text-info"></i> Yesterday
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="{{ route('getdepartment', ['id' => $dept->id, 'days'=>'thisweek']) }}" target="__blank"  class="nav-link">
                                                                <i class="far fa-circle text-info"></i>
                                                                This Week
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="{{ route('getdepartment', ['id' => $dept->id, 'days'=>'thismonth']) }}" target="__blank"  class="nav-link">
                                                                <i class="far fa-circle text-info"></i>
                                                                This Month
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="{{ route('getdepartment', ['id' => $dept->id, 'days'=>'thisyear']) }}" target="__blank"  class="nav-link">
                                                                <i class="far fa-circle text-info"></i>
                                                                This Year
                                                            </a>
                                                        </li>

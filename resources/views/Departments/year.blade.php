...
<html >
    ...
    <body style="font-size:10;">    
        ...
        <h3><u>ACTIVITY REPORT FROM {{Carbon\Carbon::parse($yearStartDate )->toFormattedDateString()}} TO {{Carbon\Carbon::parse($yearEndDate )->toFormattedDateString()}} PRINTED {{Carbon\Carbon::parse($today )->toFormattedDateString()}}.</u></h3></center>

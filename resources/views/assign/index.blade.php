...
<div class="card">
    ...
    <!-- <button type="button" class="btn btn-info btn-sm" style="float:right; margin-right:10px;" data-toggle="modal" data-target="#modal-activityGroup">Assign Group Activity</button> -->
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<div class="modal fade" id="modal-activityGroup">
    <form role="form" method="post" action="{{ route('assign.store') }}" id="activityForm">
        @csrf
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
